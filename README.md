...
The repository is being built incrementally by phase. The initial test harness confirms the C11 warning policy; cryptographic vectors will be added in the AES phases.
